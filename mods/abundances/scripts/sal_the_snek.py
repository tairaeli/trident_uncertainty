...
if not check:
    ...
    salsa.generate_lrays(ds, center.to('code_length'), args.nrays, max_impact, field_parameters={'bulk_velocity', gal_vel}, ion_list=['H I'], fields=other_fields, out_dir=(path + "/rays"))
