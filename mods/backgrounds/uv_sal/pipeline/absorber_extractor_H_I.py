...
abs_ext = salsa.AbsorberExtractor(ds, ray_file, ion_name = "H I", velocity_res =20, calc_missing=True)
...
field_name = f"H_p0_number_density"
...
for i,ray_path in enumerate(ray_arr):
    ...
    trident.add_ion_number_density_field("H", trident.from_roman("I"), 
    ...
    save_dens = open(uvb_path+"/ray_dat/"+ion.replace(" ", "_")+"/"+f"ray_{i:0{n}d}_dens_HI.pickle","wb")
